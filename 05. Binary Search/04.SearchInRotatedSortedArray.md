...
```
/*
REVISION NOTES — Search in Rotated Sorted Array (O(log n))

PROBLEM
- Sorted array with distinct values
- Rotated at unknown pivot
- Find target index in O(log n)
...
INTERVIEW ONE-LINER
- One half is always sorted; check target range and discard the other half.
*/
