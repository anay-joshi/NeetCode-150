...
### OPTIMAL Approach:
```
🌧️ Trapping Rain Water - OPTIMAL APPROACH
🧠 Intuition
We can trap water at position i only if:

There’s a higher bar on the left
...
📊 Step-by-Step Dry Run (Visual Format)
...
Each bar’s water is limited by the minimum of the tallest bars on its left and right.
